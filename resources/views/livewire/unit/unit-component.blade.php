                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <a class="btn btn-success float-right text-white" data-toggle="modal" data-target="#modalAdd">Add New Unit</a>
                            </div>
                        </div>             
                    </div>
                    <br>
                                      ...
                                      <div class="form-group" wire:ignore>          
                                        <div class="input-group">             
                                          <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Unit Name" required wire:model="name">
                                          </div>
                                        </div>
                                      </div>
